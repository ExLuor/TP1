    ...
    protected void sendMessageToUp()
    {
        ...
        switch (t.getType())
        {
            case Data:
                ...
                {
                    System.out.println("La station " + nomCouche + "envoie un ACK " + numTrame
                ...
                {
                    System.out.println("La station " + nomCouche + "envoie un NAK " + (pos)
            ...
            case ACK:
                ...
                System.out.println("La station " + nomCouche + "a reçu un ACK " + numTrame
